...
<body>
    ...
    <form action="comment_frame.php?post_id=<?php echo $post_id; ?>" id="comment_form" name="postComment<?php echo $post_id; ?>" method="post">
        <textarea name="post_body" name="post_body"></textarea>
    ...
    ?>
            <div class="comment_section">
                ...
                <b><a href="<?php echo $posted_by ?>" target="_parent"><?php echo $user_obj->getFirstAndLastName(); ?></a></b> &nbsp; &nbsp;&nbsp;
                <span class="time_message"> <?php echo $time_message; ?> </span>
